...
class FrameSelectAngles(CreateFrame):
    def __init__(self, master, name, algorithm_name, number_points, callback=None, **kwargs):
        ...
        frame_delete=CreateFrame(master=self, grid_frame=GridFrame(dim=(1,2), arr=None))
        ...
        frame_delete.insert_element(cad_pos="0,0", element=entry_triplet, padx=5, pady=5, sticky="")
        frame_delete.insert_element(cad_pos="0,1", element=button_delete, padx=5, pady=5, sticky="")
